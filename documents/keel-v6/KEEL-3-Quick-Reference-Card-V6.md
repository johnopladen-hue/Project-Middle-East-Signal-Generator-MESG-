...
> **v6 change:** new items 9 (Findings log) and 10 (Test plan) inserted before secrets; old items 9–15 shifted to 11–17.
...
**9. Findings log** *(new in v6)*
- [ ] Make `docs/findings.md` — one running, dated log. Each entry: date · context · finding · implication.
- **PROOF:** something surprising you learned this week is already a dated entry, not just a memory.

**10. Test plan** *(new in v6)*
- [ ] Make `docs/test_plan.md` — one table: Test ID · Component · Type · Description · Expected Result · Status · Date · Notes. Add a row when you write the test, not after.
- **PROOF:** the last test you wrote has a row. "Suite is green" ≠ "the thing that matters is tested" — the table is what proves the second one.

**11. Secrets out (public repo = no second chances)**
...
**13. Self-contained tests (do early)**
- [ ] Tests run isolated — no internet, no services. Add one trivial test, give it a row in the test plan (item 10).
...
- **PROOF:** (proven in item 15 — don't trust yet).

**15. PROVE the gate (never skip)**
